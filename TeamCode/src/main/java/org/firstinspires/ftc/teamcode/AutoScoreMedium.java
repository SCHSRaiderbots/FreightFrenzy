...
@Autonomous(name="Auto Score Medium", group ="CodeDev")
public class AutoScoreMedium extends OpMode {
        ...
        switch (state) {
            ...
            case STATE_TURN1:
                ...
                if (Motion.finished() && elevator.finished()) {
                    ...
                    Motion.moveTiles(MappedDistance(1.0, -1.0) - (10.5/24.0));
